describe("User can see CV", () => {
  ...
  it("displays content for work experience", () => {
      ...
      cy.get("[data-cy=research-engineer]").should("contain.text","Research Engineer")
      cy.get("[data-cy=junior-researcher]").should("contain.text","Junior Researcher")      
  ...
  it("displays content for education", () => {
      ...
      cy.get("[data-cy=fullstack-web-developer]").should("contain.text","Fullstack Web Developer")      
